...
public class Lambayeque extends Activity {

    private TextView tviTitulo;
    private ListView lstPlatosLambayeque;
    ...
    private void app(){
        ...
        lstPlatosLambayeque = (ListView) findViewById(R.id.lstPlatos);
        tviTitulo = (TextView) findViewById(R.id.tviTitulo);

        PlatoCostaRepository platoCostaRepository = new PlatoCostaRepository();
        List<PlatoEntity> data = platoCostaRepository.getPlatoLambayequeList();

        platoAdapter = new PlatoAdapter(this,
                data);
        lstPlatosLambayeque.setAdapter(platoAdapter);

        lstPlatosLambayeque.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
    ...
    private void extras() {
        if (getIntent() != null) {
            ...
            if (bundle != null) {
                provincia = (ProvinciaEntity) bundle.getSerializable("PROVLAMBAYEQUE");
            }
        }
    }
    ...
    private void gotoPlato(PlatoEntity plato) {
        ...
        Intent intent = new Intent(Lambayeque.this, Plato.class);
